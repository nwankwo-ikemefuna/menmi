...
echo form_open_multipart($this->c_controller.'/'.$type.'_ajax', $attrs);
	...
	<div class="row">
		...
		<div class="<?php echo grid_col(12, '', '5?2'); ?>">
			...
			xform_group_grid('Image', 'image', 'file', '', $type == 'add', ['help' => 'Allowed types: jpg, jpeg, png, gif. Max 1MB. <br />Ideal dimension: Home/Shop Top - 1170x520; Sidebar - 270x380; About Us - 525x380; Home Banner - 420x250']);
			?>
		</div>
	</div>
	<?php
